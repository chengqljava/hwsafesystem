...
public class Check {
    ...
    //    public static final String REGEX_MOBILE    = "^((((86)?)|([+]86)?)((13[0-9])|(14[0-9])|(15[0-9])|(17[0-9])|(18[0-9]))\\d{8})|((((60)?)|([+]60)?)(01)\\d{8,9})$";
    ...
    /** 新加波手机号匹配正则 **/
    //public static final String REGEX_MOBILE_SG = "^([+]?65)?(3|6|8|9)\\d{7}$";
    public static final String REGEX_MOBILE_SG = "^([+]?65)?\\d{8,10}$";
    /** 泰国手机号及固话匹配正则 **/
    //public static final String REGEX_MOBILE_TH = "^([+]?66)?(0)?(2|43|6|8|9)\\d{8}$";
    ...
    public static void checkMatch(String regex, String value, String errorMessageTemplate) {
        Pattern pattern = Pattern.compile(regex);
        if (!pattern.matcher(value).find()) {
            throw new CheckException(errorMessageTemplate);
        }
    ...
    public static void checkMatchMobile(String value) {
        ...
        if (!matchMobile(REGEX_MOBILE_CN, Pattern.CASE_INSENSITIVE, value)
            && !matchMobile(REGEX_MOBILE_ML, Pattern.CASE_INSENSITIVE, value)
            && !matchMobile(REGEX_MOBILE_ID, Pattern.CASE_INSENSITIVE, value)
            && !matchMobile(REGEX_MOBILE_HK, Pattern.CASE_INSENSITIVE, value)
            && !matchMobile(REGEX_MOBILE_SG, Pattern.CASE_INSENSITIVE, value)
            && !matchMobile(REGEX_MOBILE_TH, Pattern.CASE_INSENSITIVE, value)) {
            throw new CheckException();
        }
    ...
    public static void checkMatchMobileByCode(String phone, String countryCode) {
        ...
        if (StringUtils.isNoneBlank(countryCode)) {
            if ("86".equals(countryCode) || "+86".equals(countryCode)) {
                ...
                if (!matchMobile(REGEX_MOBILE_ML, Pattern.CASE_INSENSITIVE, phone)) {
                    throw new CheckException();
                }
            } else if ("65".equals(countryCode) || "+65".equals(countryCode)) {
                if (!matchMobile(REGEX_MOBILE_SG, Pattern.CASE_INSENSITIVE, phone)) {
                    throw new CheckException();
                }
            } else if ("66".equals(countryCode) || "+66".equals(countryCode)) {
                if (!matchMobile(REGEX_MOBILE_TH, Pattern.CASE_INSENSITIVE, phone)) {
                    throw new CheckException();
                }
            } else if ("62".equals(countryCode) || "+62".equals(countryCode)) {
                if (!matchMobile(REGEX_MOBILE_ID, Pattern.CASE_INSENSITIVE, phone)) {
                    throw new CheckException();
                }
            } else if ("852".equals(countryCode) || "+852".equals(countryCode)) {
                if (!matchMobile(REGEX_MOBILE_HK, Pattern.CASE_INSENSITIVE, phone)) {
                    throw new CheckException();
                }
            } else {
                throw new CheckException();
        ...
        if (!matchMobile(REGEX_MOBILE_CN, Pattern.CASE_INSENSITIVE, phone)
            && !matchMobile(REGEX_MOBILE_ML, Pattern.CASE_INSENSITIVE, phone)
            && !matchMobile(REGEX_MOBILE_SG, Pattern.CASE_INSENSITIVE, phone)
            && !matchMobile(REGEX_MOBILE_TH, Pattern.CASE_INSENSITIVE, phone)
            && !matchMobile(REGEX_MOBILE_ID, Pattern.CASE_INSENSITIVE, phone)
            && !matchMobile(REGEX_MOBILE_HK, Pattern.CASE_INSENSITIVE, phone)) {
            throw new CheckException();
        }
    }
     ...
     * @param errorMessageTemplate
     */
    public static void checkMatchMobile(String value, String errorMessageTemplate) {
        if (StringUtils.isBlank(value)) {
            throw new CheckException(errorMessageTemplate);
        }
        value = value.replaceAll(" ", "");
    ...
    public static void checkMatchIdentityCard(String value, String errorMessageTemplate) {
        if (StringUtils.isBlank(value))
            throw new CheckException(errorMessageTemplate);
        if (value.length() > 30) {
            throw new CheckException(errorMessageTemplate);
    ...
    public static void checkMatchEmail(String value, String errorMessageTemplate) {
        if (StringUtils.isBlank(value))
            throw new CheckException(errorMessageTemplate);
