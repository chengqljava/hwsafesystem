...
public class Error implements Serializable {
    ...
    public static Error build(String code, String messageTemplate, Object[] messageArgs) {
    ...
    private static Error from(ConstraintViolationException e) {
        ...
        for (ConstraintViolation violation : e.getConstraintViolations()) {
            ...
            String annotationTypeName = descriptor.getAnnotation().annotationType().getName();
            if ("javax.validation.constraints.AssertFalse".equalsIgnoreCase(annotationTypeName)) {
                ...
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("value") };
            } else if ("javax.validation.constraints.DecimalMin"
                .equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.DecimalMin";
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("value") };
            } else if ("javax.validation.constraints.Digits".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Digits";
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("integer"),
                        descriptor.getAttributes().get("fraction") };
            } else if ("javax.validation.constraints.Future".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Future";
            } else if ("javax.validation.constraints.Max".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Max";
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("value") };
            } else if ("javax.validation.constraints.Min".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Min";
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("value") };
            } else if ("javax.validation.constraints.NotNull".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.NotNull";
            } else if ("javax.validation.constraints.Null".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Null";
            } else if ("javax.validation.constraints.Past".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Past";
            } else if ("javax.validation.constraints.Pattern".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Pattern";
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("regexp") };
            } else if ("javax.validation.constraints.Size".equalsIgnoreCase(annotationTypeName)) {
                subErrorMessageTemplate = "error.illegalArgument.Size";
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("min"),
                ...
                subErrorMessageArgs = new Object[] { descriptor.getAttributes().get("script") };
            ...
            result.getErrors().add(
                new SubError(subErrorKey, subErrorMessageTemplate, subErrorMessageArgs));
        }
    ...
    public static final class SubError implements Serializable {
        ...
        public SubError(String key, String messageTemplate, Object... messageArgs) {
            this.key = key;
            this.messageTemplate = messageTemplate;
            this.messageArgs = messageArgs;
        }
