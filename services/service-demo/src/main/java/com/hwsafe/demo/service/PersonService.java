...
public class PersonService  extends ServiceImpl<PersonMapper, Person>{
	...
	public Page<Person> selectPersonPage(PersonQuery personQuery) {
		...
		Page<Person> page=new Page<Person>(personQuery.getCurrent(), personQuery.getCurrent());
        page.setRecords(baseMapper.selectListByName(page, personQuery.getName()));
        return page;
    }
	
	/* (non-Javadoc)
	 * @see com.baomidou.mybatisplus.extension.service.IService#list()
	 * 无参LIST 
	 */
