...
public class MongoDBController {
	...
	@RequestMapping("/mongo/person")
	public String  personMongo() {
		Person person=new Person();
		person.setAge(18);
		person.setName("testMongo");
	...
	@ResponseBody
	public List<Person> personMongoList() {
		Query query=new Query(Criteria.where("name").is("testMongo"));
