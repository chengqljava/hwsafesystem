...
import com.hwsafe.enterprise.controller.mq.Producer;
...
public class MqProducerController {
	   ...
	   //Direct
	    ...
	    public void sendtopicMsg() {
	        producer.sendExchangeMsg("topic-exchange","org.cord.test", "topic-exchange hello world");
	    }
	    ...
	    public void sendHeadersMsg() {
	        ...
	        map.put("First","A");
	        producer.sendHeadersMsg("headers-exchange", "headers-exchange hello word", map);
	    }
}
