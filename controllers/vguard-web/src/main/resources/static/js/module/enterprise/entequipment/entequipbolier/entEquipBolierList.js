...
//			testtime:$("#testtime").val()
    ...
    $("#addBtn").on("click", function () {
    	var entid = $("#entid").val();
    	parent.parent.openWin(BASE_URL+"/enterprise/entequipbolier/add/"+entid,'添加','60%','55%');
    });
    ...
    $("#editBtn").on("click", function () {
    	...
    	var bolierid = rowdata.BOLIERID;
    	
    	parent.parent.openWin(BASE_URL+'/enterprise/entequipbolier/edit/'+bolierid,'编辑','60%','55%');
    });
    ...
    $("#delBtn").on("click", function () {
    	...
    	for(var i=0;i<ids.length;i++){
    		...
    		bolierids[i]= rowdatas.BOLIERID;
    	}
    	var parmJson = bolierids.toString();
    	var entid = $("#entid").val();
...
function del(param){
		...
		parent.parent.confirm('确认删除吗?',function(){
			$.ajax({ 
		  		url: BASE_URL+"/enterprise/entequipbolier/delete",
		  		type:'post',
		  		dataType:'json',
		  		data:param,
