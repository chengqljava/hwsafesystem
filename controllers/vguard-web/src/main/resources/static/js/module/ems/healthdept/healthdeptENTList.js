$(document).ready(function () {
	...
	$.ajax({
		type : 'post',
		url : BASE_URL + 'ems/emsreshealthdept/getusertype',
		success : function(data) {
			$("#untUser").val(data.untUser);
		}
	});
	...
	var colname = ["主键id", "医疗机构代码","医疗机构名称","医疗机构类型","行政区划","主管单位", "医疗机构等级","填报状态","操作"],
	colmodel = [
	            {
	            	name: "DEPTID",
	            	index: "DEPTID",
	            ...
	            },
	            {
         		...
         		{name:'OPERATION',index:"OPERATION",width:'80px',fixed:true,align:"left",formatter:function(cellvalue, options, obj){
        			return '<a href="javascript:void(0);" title="编辑" class="operation editInfoBtn" onclick="editInfo(\''+obj.DEPTID+'\')">编辑</a><br>'
        			     + '<a href="javascript:void(0);" title="删除" class="operation delInfoBtn" onclick="delInfo(\''+obj.DEPTID+'\')">删除</a>'
        		}}
	         ];
