$(document).ready(function (){
	...
	function initLecTable() {
	    ...
	    //分页表格响应式处理
	    var tableHeight = $(window).height() - $(".pcheck").height() - 215 - 20;
	    $(window).resize(function () {
	        $("#lec-table").jqGrid("setGridHeight", $(window).height() - $('.pcheck').height() - 215 - 20);
	        $("#lec-table").jqGrid("setGridWidth", $(window).width() * 0.95);
	    });
	...
	function initMesTable() {
	    ...
	    var tableHeight = $(window).height() - $(".pcheck").height() - 215 - 20;
	    $(window).resize(function () {
	        $("#mes-table").jqGrid("setGridHeight", $(window).height() - $('.pcheck').height() - 215 - 20);
