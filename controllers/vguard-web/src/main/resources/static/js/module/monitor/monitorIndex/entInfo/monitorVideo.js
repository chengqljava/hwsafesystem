...
//        var tHeight = $(window).height()-520 <100?100:$(window).height()-500 ;
        ...
        $("#videoTable").jqGrid({
            ...
            rowNum: 100,
//            rowList: [10, 20, 30],
            colNames: ['编号', '名称',  'id', '查看','高度','宽度', '类型', 'ipaddr', 'hyplayport', 'strdomaincode', 'strdevicecode', 'strchannelcode', 'strstreamcode'],
            colModel: [
...
//                        return '<a onclick="showVideoDiv(\'' + obj.videoid + '\')" href="javascript:void(0);"><img height="18px" width="18px" src="' + BASE_URL + '/images/monitor/gis/check.png"></a>';
                        return '<a onclick="showVideoDiv(\''+obj.videoid+'\',\''+obj.videoType+'\',\''+obj.ipaddr+'\',\''+obj.hyplayport+'\',\''+obj.strdomaincode+'\',\''+obj.strdevicecode+'\',\''+obj.strchannelcode+'\',\''+obj.strstreamcode+'\')" href="javascript:void(0);"><img height="18px" width="18px" src="' + BASE_URL + '/images/monitor/gis/check.png"></a>';
                    }
                },{
                ...
                {
                    name: 'ipaddr', index: 'left', width: '20%',hidden:true
                },
                {
                	name: 'hyplayport', index: 'left', width: '20%',hidden:true
                },
                {
                	name: 'strdomaincode', index: 'left', width: '20%',hidden:true
                },
                {
                	name: 'strdevicecode', index: 'left', width: '20%',hidden:true
                },
                {
                	name: 'strchannelcode', index: 'left', width: '20%',hidden:true
                },
                {
                	name: 'strstreamcode', index: 'left', width: '20%',hidden:true
                }
            ],
...
//        $("#videoTable").setGridWidth($(window).width()-$(".probeInfo").width()-30);
    ...
    initVideoPoint:function (data) {
        ...
        _.map(arr, function (num, key) {
            ...
            " data-ipaddr='" + num.ipaddr + "' " + "data-hyplayport='" + num.hyplayport + "' " + "data-strdomaincode='" + num.strdomaincode + "' " +
            " data-strdevicecode='" + num.strdevicecode + "' " + "data-strchannelcode='" + num.strchannelcode + "' " + "data-strstreamcode='" + num.strstreamcode + "' " +
