$(document).ready(function() {
	...
	var colname = ['机构id','机构名称','机构编码','负责人','移动电话'];
	var colmodel = [
    ...
    $("#grid-table").jqGrid({
    	height: tableHeight,
    	url : BASE_URL+"/system/sysorg/list",
		datatype: "json",
		cache : false,
		mtype : 'post',
		colNames:colname,
...
$("#editBtn").bind("click",function(){
	...
	parent.openWin(BASE_URL+'/system/sysorg/edit/'+orgid,'编辑',"55%","60%");
});

/*添加*/
$("#addBtn").bind("click",function(){
	parent.openWin(BASE_URL+'/system/sysorg/add','添加',"55%","60%");
});
...
function display(orgid){
	parent.openWin(BASE_URL+'/system/sysorg/display/'+orgid,'详细',"55%","60%");
}
