...
$(document).ready(function() {
    ...
    $("#grid-table").jqGrid({
    	height: tableHeight,
    	url : BASE_URL + "/monitor/macprobehost/loadList",
		datatype: "json",
		cache : false,
		mtype : 'post',
		colNames:colname,
...
$("#addBtn").on("click", function () {
	parent.openWin(BASE_URL+"/monitor/macprobehost/addENT",'添加','65%','65%');
});
...
$("#editBtn").on("click", function () {
	...
	parent.openWin(BASE_URL+'/monitor/macprobehost/editENT/'+PROBEHOSTID,'编辑','65%','65%');
});

/*详细查询*/
function display(PROBEHOSTID){
	parent.openWin(BASE_URL+"/monitor/macprobehost/displayENT/"+PROBEHOSTID,'详细','65%','65%');
}
/**
 * 选择一条视频主机
 */
