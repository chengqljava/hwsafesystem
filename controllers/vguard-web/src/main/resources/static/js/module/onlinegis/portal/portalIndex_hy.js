...
function initZdwxyMapPts() {
    ...
    $("#emsResCntDiv, #hidCountDiv," +
      "#hidStateCountDiv, #hidLevelCountDiv, #qyjgCntDiv, #yjzyCntDiv").hide();
    $("#entCount").text("企业：0家");
...
function initQyjgMapPts() {
    ...
    $("#hidCountDiv, #zdwxyCntDiv, #dangerCountDiv," +
      " #emsResCntDiv,#hidStateCountDiv, #yjzyCntDiv, #hidLevelCountDiv").hide();
...
function initYhfbMapPts(year, quarter) {
    ...
    $("#zdwxyCntDiv, #qyjgCntDiv," +
      " #yjzyCntDiv, #entCountDiv, #dangerCountDiv, #emsResCntDiv").hide();
...
//                                                        	 			if ("4028fa81633a32a001633a446eab01b5" == videoid) {
//                                                         					mbedeviceShowObj.serviceUrl.strDomainCode = (window.hyVideoList[0]).STRDOMAINCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strDeviceCode = (window.hyVideoList[0]).STRDEVICECODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strChannelCode = (window.hyVideoList[0]).STRCHANNELCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strStreamCode = (window.hyVideoList[0]).STRSTREAMCODE;
//                                                         				} else if ("4028fa81633a32a001633a46bfa301c9" == videoid) {
//                                                         					mbedeviceShowObj.serviceUrl.strDomainCode = (window.hyVideoList[1]).STRDOMAINCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strDeviceCode = (window.hyVideoList[1]).STRDEVICECODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strChannelCode = (window.hyVideoList[1]).STRCHANNELCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strStreamCode = (window.hyVideoList[1]).STRSTREAMCODE;
//                                                         				} else if ("4028fa81633a32a001633a4790f501dd" == videoid) {
//                                                         					mbedeviceShowObj.serviceUrl.strDomainCode = (window.hyVideoList[2]).STRDOMAINCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strDeviceCode = (window.hyVideoList[2]).STRDEVICECODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strChannelCode = (window.hyVideoList[2]).STRCHANNELCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strStreamCode = (window.hyVideoList[2]).STRSTREAMCODE;
//                                                         				} else if ("4028fa81633a32a001633a48672d01f0" == videoid) {
//                                                         					mbedeviceShowObj.serviceUrl.strDomainCode = (window.hyVideoList[3]).STRDOMAINCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strDeviceCode = (window.hyVideoList[3]).STRDEVICECODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strChannelCode = (window.hyVideoList[3]).STRCHANNELCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strStreamCode = (window.hyVideoList[3]).STRSTREAMCODE;
//                                                         				} else if ("4028fa81633a32a001633a4943c40204" == videoid) {
//                                                         					mbedeviceShowObj.serviceUrl.strDomainCode = (window.hyVideoList[4]).STRDOMAINCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strDeviceCode = (window.hyVideoList[4]).STRDEVICECODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strChannelCode = (window.hyVideoList[4]).STRCHANNELCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strStreamCode = (window.hyVideoList[4]).STRSTREAMCODE;
//                                                         				} else {
//                                                         					mbedeviceShowObj.serviceUrl.strDomainCode = (window.hyVideoList[1]).STRDOMAINCODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strDeviceCode = (window.hyVideoList[1]).STRDEVICECODE;
//                                                         			 		mbedeviceShowObj.serviceUrl.strChannelCode = (window.hyVideoList[1]).STRCHANNELCODE;
...
function initYjzyMapPts() {
    ...
    $("#hidCountDiv, #zdwxyCntDiv, #dangerCountDiv, #entCountDiv, " +
      "#hidLevelCountDiv, #hidStateCountDiv, #qyjgCntDiv").hide();
...
//                var ysbzAnaData = [
//                    {
//                        "resId": "4028ef7b5ed04582015ed0b934560121",
//                        "resName": "消毒车",
//                        "resLng": "116.8653",
//                        "resLat": "37.2755",
//                        "belOrgName": "德州科顺建筑材料有限公司",
//                        "resType": "运输保障",
//                        "trantoolcode": "YSBZ110000",
//                        "usage": "卫生消毒",
//                        "storeadd": "山东省德州市临邑县经济开发区",
//                        "majordept": "临邑安监局",
//                        "weight": "50",
//                        "personnum": "60",
//                        "resperson": "张大龙",
...
//                    },
//                    {
//                        "resId": "4028ef7b5ed04582015ed0b851342321",
//                        "resName": "物资运输车",
//                        "resLng": "116.8976",
//                        "resLat": "37.3195",
//                        "belOrgName": "德宝路股份有限公司",
//                        "resType": "运输保障",
//                        "trantoolcode": "YSBZ110090",
//                        "usage": "物资输送",
//                        "storeadd": "山东省德州市临邑县经济开发区",
//                        "majordept": "临邑安监局",
//                        "weight": "10",
...
//                    },
//                    {
//                        "resId": "4028ef7b5ed04582015ed0b851360951",
//                        "resName": "危化品救援车",
//                        "resLng": "116.8456",
//                        "resLat": "40.2707",
//                        "belOrgName": "德宝路股份有限公司",
//                        "resType": "运输保障",
//                        "trantoolcode": "YSBZ110055",
//                        "usage": "危化品转移",
//                        "storeadd": "山东省德州市临邑县经济开发区",
//                        "majordept": "临邑安监局",
//                        "weight": "50",
...
//                var txbzAnaData = [
//                    {
//                        "resId": "4028d8f5493b23f101494f2a03073516",
//                        "resName": "卫星通讯保障",
//                        "resLng": "116.8663",
//                        "resLat": "37.3105",
//                        "belOrgName": "德宝路股份有限公司",
...
//                    },
//                    {
//                        "resId": "4028d8f5493b23f101494f2a03070125",
//                        "resName": "电信通讯保障",
//                        "resLng": "116.8739",
//                        "resLat": "37.2928",
//                        "belOrgName": "德州科顺建筑材料有限公司",
//                        "resType": "通信保障",
//                        "entname": "德州科顺建筑材料有限公司",
//                        "resbztype": "电信通讯",
//                        "lvl": "市级",
//                        "disarea": "临邑经开区",
//                        "address": "山东省德州市临邑县经济开发区",
...
//                    },
//                    {
//                        "resId": "4028d8f5493b23f101494f2a03073687",
//                        "resName": "电力线路抢修工程1小队",
//                        "resLng": "116.8689",
//                        "resLat": "37.2608",
//                        "belOrgName": "德州科顺建筑材料有限公司",
...
//
//                //判断是否包含模拟的两类点位数据
//                if (_.contains(resTypeParaArr, "8")) {
//                    //汇总运输保障点位数据
//                    retData.emsResList = _.union(retData.emsResList, ysbzAnaData);
//
//                    if (-1 < "德州科顺建筑材料有限公司".indexOf("" != $yjzy.find(".searchBox").val() ? $yjzy.find(".searchBox").val() : "null") ||
//                        -1 < "德宝路股份有限公司".indexOf("" != $yjzy.find(".searchBox").val() ? $yjzy.find(".searchBox").val() : "null") /*||
//                        -1 < "内蒙古荣信化工有限公司".indexOf("" != $yjzy.find(".searchBox").val() ? $yjzy.find(".searchBox").val() : "null")*/
//                    ) {
//                        retData.emsResCntPieData = _.union(retData.emsResCntPieData, [{"name": "运输保障", "value": "1"}]);
//                    } else {
//                        retData.emsResCntPieData = _.union(retData.emsResCntPieData, [{"name": "运输保障", "value": "3"}]);
//                    }
//                }
//                if (_.contains(resTypeParaArr, "9")) {
//                    //汇总通信保障点位数据
//                    retData.emsResList = _.union(retData.emsResList, txbzAnaData);
//
//                    if (-1 < "德州科顺建筑材料有限公司".indexOf("" != $yjzy.find(".searchBox").val() ? $yjzy.find(".searchBox").val() : "null") ||
//                        -1 < "德宝路股份有限公司".indexOf("" != $yjzy.find(".searchBox").val() ? $yjzy.find(".searchBox").val() : "null") /*||
//                        -1 < "内蒙古荣信化工有限公司".indexOf("" != $yjzy.find(".searchBox").val() ? $yjzy.find(".searchBox").val() : "null")*/
//                    ) {
//                        retData.emsResCntPieData = _.union(retData.emsResCntPieData, [{"name": "通信保障", "value": "1"}]);
//                    } else {
//                        retData.emsResCntPieData = _.union(retData.emsResCntPieData, [{"name": "通信保障", "value": "3"}]);
//                    }
//                }
//                retData.emsResList = _.filter(retData.emsResList, function (tmpRes) {
//                    return -1 < tmpRes.belOrgName.indexOf($yjzy.find(".searchBox").val());
//                });
