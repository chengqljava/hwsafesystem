...
//		alert("schemaId" + schemaId);
		...
		$(window).resize(function(){
			$("#secEvnGrid-table").jqGrid( 'setGridHeight', $(window).height() - $('.pcheck').height() - 190 -33 );
			$("#secEvnGrid-table").jqGrid( 'setGridWidth', $(window).width()*0.95 );
		});
	    ...
	    $("#secEvnGrid-table").jqGrid({
			...
			loadComplete: function() {
				if($(window).width() < 700) {
					...
					$("#secEvnGrid-table").closest(".ui-jqgrid-bdiv").css({ "overflow-x" : "hidden"});
//					$(".ui-jqgrid-hdiv").css({ "overflow-x" : "scroll"});
				...
				$("#secEvnGrid-table").jqGrid( 'setGridHeight', $(window).height() - $('.pcheck').height() - 190 );
				$("#secEvnGrid-table").jqGrid( 'setGridWidth', $(window).width()*0.95 );
//				if($(window).width() < 700) {
//					$('.ui-jqgrid-htable').css({"width":"900"});
//					$("#secEvnGrid-table").css({"width":"900"});
