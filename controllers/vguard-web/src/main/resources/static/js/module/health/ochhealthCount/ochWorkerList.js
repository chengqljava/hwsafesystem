$(document).ready(function() {
	...
	var colmodel = [
					...
					{name:'STATE',index:'STATE',formatter:
                         function(cellvalue, options, obj) { 
    ...
    $("#grid-table").jqGrid({
    	height: tableHeight,
    	url : BASE_URL + "/health/ochcount/wokersInfo",
		datatype: "json",
		cache : false,
		mtype : 'post',
		colNames:colname,
...
function display(workerid){
	parent.openWin(BASE_URL+'/health/ochworker/labelpage/menuDisplay/'+workerid,'预案编辑','70%','80%');
}
