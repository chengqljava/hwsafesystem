  ...
  //分页表格响应式处理
    ...
    $("#addBtn").off("click").on("click", function () {
        parent.openWin(BASE_URL
            + "views/module/hidden/hiddendanger/enthiddendangerAdd.html?dangerid=-1",
            '新增隐患记录', '65%', '80%');
    });
    ...
    $("#editBtn").off("click").on("click", function () {
        ...
        parent.openWin(BASE_URL + "views/module/hidden/hiddendanger/enthiddendangerAdd.html?dangerid=" + dangerid,
            "编辑隐患记录", "65%", "80%");
    });
