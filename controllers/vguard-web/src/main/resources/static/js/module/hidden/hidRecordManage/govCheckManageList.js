...
$(function () {
    ...
    //列表分页表格
    var colname = [
            "隐患排查记录id","检查对象", "检查记录名称","检查区域","检查项(项)","检查人员","检查时间","关联计划","检查进度","检查状态"
        ],
        colmodel = [
            {
                name: "CHECKRECORDID",
    ...
    $("#editBtn").off("click").on("click", function () {
        ...
        parent.openWin(BASE_URL + "views/module/hidden/hidRecordManage/addOrEditCheckRecord.html?checkrecordid="+checkrecordid,
            "编辑隐患排查记录", "65%", "80%");
    });
