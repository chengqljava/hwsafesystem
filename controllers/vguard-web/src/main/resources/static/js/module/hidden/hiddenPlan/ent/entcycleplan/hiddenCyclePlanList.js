...
$(document).ready(function () {
    ...
    $("#addBtn").off("click").on("click", function (){
    	parent.openWin(BASE_URL
				+ "views/module/hidden/hiddenPlan/ent/entcycleplan/addCyclePlan.html?checkplanid=-1",
				'新增周期计划', '53%', '73%');
    });
    ...
    $("#editBtn").off("click").on("click", function () {
        ...
        parent.openWin(BASE_URL + "views/module/hidden/hiddenPlan/ent/entcycleplan/addCyclePlan.html?checkplanid=" + checkplanid,
            "编辑周期计划", '55%', '75%');
    });
