$(document).ready(function() {
    ...
    $("#grid-table").jqGrid({
        ...
        postData:{
            ...
            emsplaorgflag:"emsplaorgflag"//传递到后台 标志是应急预案查询
        },
        sortname : 'ORGNO',
        sortorder : "asc",
        viewrecords : true,
...
$("#saveBtn").on("click",function(){
    ...
    var selectIds = orgids.toString();
    
    $.ajax({
        type : 'post',
        url : BASE_URL + '/ems/emsplaorg/save',
        cache : false,
        dataType : 'json',
        data : {emsResOrgIds:selectIds,planid:$("#planid").val(),token:$("#token").val()},
        global : false,
