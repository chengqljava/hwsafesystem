$(document).ready(function() {
	...
	$.ajax({
		type : "post",
		url : BASE_URL + "ems/emsreshealthdept/load/"+GetQueryString("deptid"),
		data : {},
		success : function(data) {
			if (data) {
				var emsHealthDeptTpt = _.template($("#emsHealthDeptTpt").html());
				$("#emsHealthDeptForm").html(emsHealthDeptTpt(data));
				...
				SelectOption.loadHospitalGrade("deptgradecode");// 医院级别
			    ...
			    $.getJSON(BASE_URL + "/config/gisPtAreaRange.json", function(data) {
			    	...
			    	$("#emsHealthDeptForm").validate(validateOpts);
			    });
			}
		}
	});
...
function save(){
	$.ajax({
		type : 'post',
		url : BASE_URL + 'ems/emsreshealthdept/save',
		cache : false,
		dataType : 'json',
		data : $("#emsHealthDeptForm").serializeArray(),
		global : false,
