...
$(function () {
    ...
    //列表分页表格
    var colname = [
            "隐患排查计划id","计划名称", "计划主题","计划检查项目","负责人","开始时间","检查进度","计划状态"
        ],
        colmodel = [
            {
                name: "CHECKPLANID",
    ...
    $("#addBtn").off("click").on("click", function () {
        parent.openWin(BASE_URL
            + "views/module/hidden/hiddenPlan/ent/entcommonplan/entcommonplanAdd.html?checkplanid=-1",
            '新增安全检查计划', '65%', '80%');
    });
    ...
    $("#editBtn").off("click").on("click", function () {
        ...
        parent.openWin(BASE_URL + "views/module/hidden/hiddenPlan/ent/entcommonplan/entcommonplanAdd.html?checkplanid=" + checkplanid,
            "编辑安全检查计划", "65%", "80%");
    });
