$(document).ready(function () {
    ...
    var colname = ["演练计划id", "演练计划名称", "预案名称", "演练组织单位", "演练督导单位", "计划演练时间", "演练地点", "演练形式","状态"],
        colmodel = [
            {
                name: "PID",
                index: "PID",
...
//    });
    ...
    $("#addBtn").off("click").on("click", function () {
        parent.openWin(BASE_URL
            + "views/module/ems/emsdrillplan/emsdrillplanAdd.html?pid=-1",
            '添加演练计划', '50%', '60%');
    });
    ...
    $("#editBtn").off("click").on("click", function () {
        ...
        // TODO 弹出编辑框
        parent.openWin(BASE_URL
            + "views/module/ems/emsdrillplan/emsdrillplanAdd.html?pid=" + pid,
            '修改演练计划', '50%', '60%');
