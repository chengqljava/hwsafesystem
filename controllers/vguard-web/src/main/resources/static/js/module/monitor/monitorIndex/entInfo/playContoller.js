...
//    	OCXobj.SetCapturParam("C:\\pic",0);//图片保存路径，格式
    ...
    /*****实时预览******/
    function StartPlayView(previewXml,lWndIndex)
    {
        var OCXobj = document.getElementById("PlayViewOCX");
		var ret = OCXobj.StartTask_Preview_InWnd(previewXml,lWndIndex);
    }
    /*****停止所有预览******/
    ...
    $("#playBtn").off("click").on("click",function(){
    	if ("none" != $("#PlayViewOCX").css("display")) {
    		StartPlayView($("#videoXmlInfo").val());
    	}
    });
    /*function PTZStop(){
    	console.log($("#videoXmlInfo").val());
    }*/
