...
var layer = {
  ...
  config: function(options, fn){
    ...
    layer.use('../../../css/theme/'+skin+'/layer/layer.css', (options.extend && options.extend.length > 0) ? (function loop(){
...
layer.close = function(index){
	for(var i=0;i<layer.dialogArr.length;i++){
		if(index==layer.dialogArr[i]){
			layer.dialogArr.splice(i, 1);
			break;
		}
	}
...
'function' === typeof define ? define(function(){
  ...
  return layer;
   ...
   ready.run();
   layer.use('../../../css/theme/'+skin+'/layer/layer.css');
}();
